...
export default function Home() {
  ...
  return (
    <section
      ...
      className="absolute w-full bg-white flex flex-col justify-center items-center"
    >
      <div>
        ...
        <p className="text-[var(--font-body)] text-xl max-w-3xl tracking-wider">
          ...
          se informar com artigos sobre sustentabilidade e visualizar o impacto
          ambiental no Brasil através de um mapa interativo. Juntos, podemos
          construir um futuro mais verde e consciente. Vamos começar?
        </p>
      </div>
    </section>
  );
